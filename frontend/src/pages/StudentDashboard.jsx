...
//   // ✅ Fetch both all courses + enrolled courses
//   const fetchData = async () => {
//     try {
//       const [allCourses, enrolled] = await Promise.all([
//         API.get("/courses"),           // public
//         API.get("/enrollments"),       // protected
//       ]);

//       setCourses(allCourses.data);
//       setEnrolledCourses(Array.isArray(enrolled.data) ? enrolled.data : []);
//     } catch (err) {
//       console.log(err);
...
//       fetchData();
//     } catch (err) {
//       alert("❌ Enrollment failed (maybe already enrolled or not logged in)");
//     }
//   };
...
//               <div
//                 key={c.id}
//                 className="bg-white p-5 rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 transition duration-300"
//               >
